...
# Log the single day highest peak prediction to a CSV file
...
# Log the full 14-day prediction to a CSV file
...
#TODO: Add detection if prediction already logged to avoid duplicates
